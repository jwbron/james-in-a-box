...
"""
            ...
            if to_delete:
                cleanup_section = (
                    "### Cleanup\n"
                    f"- Removed {len(to_delete)} old report(s) to maintain max 5 reports\n\n"
                )
...
{cleanup_section}See the full report in `docs/analysis/beads/beads-health-{timestamp}.md` for detailed analysis.
"""
