...
| [Slack Integration Strategy](adr/ADR-Slack-Integration-Strategy-MCP-vs-Custom.md) | Bidirectional Slack communication approach |
| [Message Queue Integration](adr/ADR-Message-Queue-Slack-Integration.md) | GCP Pub/Sub migration plan for Slack |
| [Slack Bot GCP Integration](adr/ADR-Slack-Bot-GCP-Integration.md) | GCP-hosted Slack bot architecture |
| [GCP Deployment](adr/ADR-GCP-Deployment-Terraform.md) | Terraform-based GCP deployment strategy |
| [Internet Tool Access Lockdown](adr/ADR-Internet-Tool-Access-Lockdown.md) | Security restrictions on network access |
...
| **Context sync modifications** | [ADR: Context Sync](adr/ADR-Context-Sync-Strategy-Custom-vs-MCP.md) | [Setup Overview](setup/README.md) |
| **GCP deployment changes** | [ADR: GCP Deployment](adr/ADR-GCP-Deployment-Terraform.md) | [ADR: Slack GCP](adr/ADR-Slack-Bot-GCP-Integration.md) |
| **Documentation updates** | [ADR: Doc Index Strategy](adr/ADR-LLM-Documentation-Index-Strategy.md) | This file |
...
> **Note:** Machine-readable indexes are generated by automated analysis. See [ADR: Doc Index Strategy](adr/ADR-LLM-Documentation-Index-Strategy.md) for details.
...
1. [ADR: Autonomous SE](adr/ADR-Autonomous-Software-Engineer.md) - Full architecture
