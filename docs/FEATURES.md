...
>
> **Total Features:** 48 top-level features
...
### 26. Documentation Generator Pipeline
**Location:**
...
### 27. Documentation Drift Detector
...
### 31. Confluence Documentation Watcher
...
Unified LLM interface for Claude via the Claude Agent SDK. All jib-tasks use `from llm import run_agent` for consistent LLM interactions.
...
- **Unified Result Handling** (`jib-container/llm/result.py`)
  - Common `AgentResult` dataclass providing standardized success/error status, stdout/stderr capture, and return codes.
...
### 42. Documentation Search Utility
...
### 49. GitHub Token Refresher Service
**Location:**
