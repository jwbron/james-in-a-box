...
Edit `~/repos/james-in-a-box/internal/host-notify-slack.sh`:
...
ExecStart=/home/jwies/repos/james-in-a-box/internal/host-notify-slack.sh
Restart=on-failure
RestartSec=10
...
Type=simple
Environment="SLACK_TOKEN=xoxb-your-token-here"
ExecStart=%h/repos/james-in-a-box/internal/host-notify-slack.sh
Restart=on-failure
RestartSec=10
...
- **Main Script**: `~/repos/james-in-a-box/internal/host-notify-slack.sh`
