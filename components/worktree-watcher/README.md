...
```bash
cd ~/khan/james-in-a-box/components/worktree-watcher
./setup.sh
```
...
~/khan/james-in-a-box/components/worktree-watcher/worktree-watcher.sh
```
...
```bash
chmod +x ~/khan/james-in-a-box/components/worktree-watcher/worktree-watcher.sh
```
