...
def create_env_file():
    ...
    base_url = get_user_input(
        ...
        "https://khanacademy.atlassian.net/wiki"
    )
    
    username = get_user_input(
        "Enter your Confluence username (email)",
        "your.email@company.com"
    )
    
    api_token = get_user_input(
    ...
    space_keys = get_user_input(
        "Enter space keys to sync (comma-separated)",
        "TEAM,DEV,ARCH"
    )
    
    output_format = get_user_input(
        "Choose output format (html/markdown)",
        "html"
    ).lower()
