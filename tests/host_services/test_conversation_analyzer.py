...
class TestConversationAnalyzerMetrics:
    ...
    def test_calculate_basic_metrics(self):
        ...
        quality_scores = [
            l["outcome"]["quality_score"] for l in logs if l["outcome"]["quality_score"] is not None
        ]
...
class TestConversationAnalyzerPatterns:
    ...
    def test_identify_high_quality_patterns(self):
        ...
        logs = [
            {"outcome": {"quality_score": 9}, "metrics": {"message_count": 5, "tool_calls": 10}},
            {"outcome": {"quality_score": 10}, "metrics": {"message_count": 4, "tool_calls": 8}},
            {"outcome": {"quality_score": 5}, "metrics": {"message_count": 20, "tool_calls": 50}},
        ]
        ...
        low_quality = [
            l
            for l in logs
            if l["outcome"].get("quality_score") is not None and l["outcome"]["quality_score"] <= 5
        ]
        ...
        high_avg_messages = sum(l["metrics"]["message_count"] for l in high_quality) / len(
            high_quality
        )
        low_avg_messages = sum(l["metrics"]["message_count"] for l in low_quality) / len(
            low_quality
        )
    ...
    def test_identify_efficient_patterns(self):
        ...
        logs = [
            {"outcome": {"iterations": 1}, "metrics": {"duration_seconds": 300}},
            {"outcome": {"iterations": 1}, "metrics": {"duration_seconds": 400}},
            {"outcome": {"iterations": 3}, "metrics": {"duration_seconds": 1200}},
        ]
...
class TestConversationAnalyzerRecommendations:
    ...
    def test_low_single_iteration_recommendation(self):
        ...
        metrics = {"single_iteration_success_rate": 40, "successful_sessions": 10}
