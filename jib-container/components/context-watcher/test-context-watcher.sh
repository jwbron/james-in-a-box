...
for script in ~/khan/james-in-a-box/jib-container/components/context-watcher/context-watcher.sh ~/khan/james-in-a-box/jib-container/components/context-watcher/context-watcher-ctl; do
    if [ -x "$script" ]; then
...
if ~/khan/james-in-a-box/jib-container/components/context-watcher/context-watcher-ctl status >/dev/null 2>&1; then
    echo "  ✓ Watcher is running"
    ~/khan/james-in-a-box/jib-container/components/context-watcher/context-watcher-ctl status | tail -5
else
    echo "  ℹ Watcher is not running"
    echo "    Start with: ~/khan/james-in-a-box/jib-container/components/context-watcher/context-watcher-ctl start"
fi
echo ""
...
echo ""
echo "Next steps:"
echo "1. If watcher is not running: ~/khan/james-in-a-box/jib-container/components/context-watcher/context-watcher-ctl start"
